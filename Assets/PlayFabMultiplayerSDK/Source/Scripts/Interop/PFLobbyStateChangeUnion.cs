namespace PlayFab.Multiplayer.Interop
{
    ...
    internal struct PFLobbyStateChangeUnion
    {
        ...
        [FieldOffset(0)]
        internal readonly PFLobbyCreateAndClaimServerLobbyCompletedStateChange createAndClaimServerLobbyCompleted;
        [FieldOffset(0)]
        internal readonly PFLobbyClaimServerLobbyCompletedStateChange claimServerLobbyCompleted;
        [FieldOffset(0)]
        internal readonly PFLobbyServerPostUpdateCompletedStateChange serverPostUpdateCompleted;
        [FieldOffset(0)]
        internal readonly PFLobbyServerDeleteLobbyCompletedStateChange serverDeleteLobbyCompleted;
    }
}
